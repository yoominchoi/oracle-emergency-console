    ...
    if user[2] == 'A':
        ...
        if incidents:
            ...
            if selected_incident_id:
                ...
                # [(datetime.datetime(2024, 7, 18, 17, 22, 16, 171897), 'Katrina Wilson', None, '939393939'), 
                # (datetime.datetime(2024, 7, 17, 14, 57, 12, 13223), 'John Smith', None, None), 
                # (datetime.datetime(2024, 7, 17, 14, 56, 59, 344175), 'Breanna Gupta', None, None), 
                # (datetime.datetime(2024, 7, 17, 14, 56, 24, 840168), 'Sarah Kim', None, None), 
                # (datetime.datetime(2024, 7, 16, 16, 48, 36, 236251), 'Katrina Wilson', 'aaaaaaggdsgdsgsdg', None), 
                # (datetime.datetime(2024, 7, 16, 16, 48, 26, 28085), 'Katrina Wilson', None, 'Be careful. 22222'), 
                # (datetime.datetime(2024, 7, 16, 16, 48, 1, 585462), 'Katrina Wilson', None, 'Be careful.'), (datetime.datetime(2024, 7, 16, 16, 47, 0, 73158), 'Katrina Wilson', None, 'Be careful.'), (datetime.datetime(2024, 7, 16, 15, 18, 15, 311083), 'John Smith', 'bbbbbbbbb', None), (datetime.datetime(2024, 7, 15, 21, 55, 28, 729022), 'John Smith', None, 'Hello Everyone'), (datetime.datetime(2024, 7, 15, 21, 55, 28, 729022), 'John Smith', 'aaaaaa', None), (datetime.datetime(2024, 7, 15, 21, 55, 28, 729022), 'John Smith', 'bb aabbb', None), (datetime.datetime(2024, 7, 13, 12, 0), 'Katrina Wilson', 'Building 400 Floor 3', 'Escape Now')]
                if incident_details:
                    print('incident detailsincident detailsincident detailsincident details', incident_details)
